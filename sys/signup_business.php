	    ...
	    <div class="col-12 col-md-7 col-lg-6 auth-main-col text-center p-5">
		    <div class="d-flex flex-column align-content-end">
			    <div class="app-auth-body mx-auto">	
					...
					<h2 class="auth-heading text-center mb-4">สมัครใช้งานผู้ประกอบการ</h2>					
					...
					<div class="auth-form-container text-start mx-auto">
						<form method="post" action="insert.php" class="auth-form auth-signup-form">         
							...
							<div class="email mb-3">
								...
								<input id="signup-email" name="Username" type="text" class="form-control signup-email" placeholder="Email" required="required">
							</div>
							<div class="password mb-3">
								...
								<input id="signup-password" name="Userlevel" type="hidden" value="B" class="form-control signup-password" placeholder="Create a password" required="required">
							</div>
							
							
							<div class="text-center">
								<button type="submit" class="btn app-btn-primary w-100 theme-btn mx-auto">สมัคร</button>
							</div>
						</form><!--//auth-form-->
