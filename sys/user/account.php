...
if (!$_SESSION["UserID"]) {
  ...
  <path fill-rule="evenodd" d="M10 5a2 2 0 1 1-4 0 2 2 0 0 1 4 0zM8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm6 5c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z"/>
							...
							<div class="app-card-body px-4 w-100">
							    ...
							    <div class="item border-bottom py-3">
								    <div class="row justify-content-between align-items-center">
									    ...
									    <div class="col text-end">
										<input  class="form-control signin-email" type="text"  value="<?php echo $row["Firstname"]; ?>"  required name="Firstname" placeholder="Username">
										<input  class="form-control signin-email" type="hidden"  value="<?php echo $row["ID"]; ?>"  required name="ID" placeholder="Username">
									    </div><!--//col-->
								    </div><!--//row-->
							    </div><!--//item-->
							    <div class="item border-bottom py-3">
						    ...
						    <div class="app-card-footer p-4 mt-auto">
							  <button class="btn btn-warning" > แก้ใขโปรไฟล์ </button> </form>
						    </div><!--//app-card-footer-->
						    ...
						    <div class="app-card-body px-4 w-100">
							    ...
							    <div class="item border-bottom py-3">
								    <div class="row justify-content-between align-items-center">
									    ...
									    <div class="col text-end">
										<input  class="form-control signin-email" type="hidden"  value="<?php echo $row["ID"]; ?>"  required name="ID" placeholder="Username">
									   <input  class="form-control signin-email" type="text"  required name="Password" placeholder="Password">
									    </div><!--//col-->
								    </div><!--//row-->
							    </div><!--//item-->
							    <div class="item border-bottom py-3">
