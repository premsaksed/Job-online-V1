    ...
    <div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
				    ...
				    <div class="col-auto">
					     <div class="page-utilities">
						    <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
							    <div class="col-auto">
								<form action="Rwork.php" method="get" class="docs-search-form row gx-1 align-items-center">
								<!-- <form method="post" action="Rwork.php" class="docs-search-form row gx-1 align-items-center"> -->
					                    <div class="col-auto">
			    ...
			    <div class="row g-4">
				<?php $sql = "SELECT * FROM work INNER JOIN user ON  work.estab = user.ID ";
